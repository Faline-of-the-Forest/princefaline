...
export const RULES = [
  ...
  {label:'The Demon', title:'The Demon', blocks:[
    ...
    {t:'p', text:'A Student may Call a Challenge on the Demon (unless she holds 5 Drama), narrating how the situation works against it. She gains 1 Drama for Calling, plus 1 more for every Bad End step currently marked, capped at the Drama max of 5 — but never gains more from the result. The Demon rolls and succeeds on 4–6.'},
